<template>
  <div class="lv_wrap">
    ...
    <ul class="lv_bd_tab">
      ...
      <li :class="activeIndex===1?'active':''" @click="allList4NewStyle(1,1,8)">政策法规</li>
      <li :class="activeIndex===2?'active':''" @click="allList4NewStyle(2,1,8)">标准规范</li>
      <li :class="activeIndex===3?'active':''" @click="allList4NewStyle(3,1,8)">垃圾分类知识</li>
      <li :class="activeIndex===4?'active':''" @click="allList4NewStyle(4,1,8)">操作指南</li>
    </ul>
